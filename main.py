...
def build_train_test_split_batches(dataset, batch_size):
    # Input and target data
    padded_input_sequences = dataset.pad_input_sequences()
    targets = dataset.targets

    # Get training, validaiton, and testing datasets
...
if __name__ == "__main__":
    ...
    train_loader, valid_loader, test_loader = build_train_test_split_batches(dataset, batch_size)
